...
let main =
   ...
   let s1 = newVariable (id_make "s1") TYPE_char true in
   let s2 = newVariable (id_make "s2") TYPE_char true in
   let s3 = newVariable (id_make "s3") TYPE_char true in
   ...
   let b1 = newVariable (id_make "b1") TYPE_char true in
   ignore b1;
